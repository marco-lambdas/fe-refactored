...
import CreateCartCardWrapper from './create-cart-card-wrapper';
...
const CreateCartCard: React.FC<Props> = ({ register, errors, watch, image }) => {
  const positions = watch([
    ...
    'clubCartX',
    'clubCartY',
    'playerPhotoCartHeight',
    'playerPhotoCartWidth',
    'playerPhotoCartX',
    'playerPhotoCartY',
  ]);

  return (
    <CreateCartCardWrapper positions={positions}>
      <Grid container spacing={2} justify='center' alignItems='center'>
        ...
        <Grid item xs={12} lg={6}>
          <PositionFields register={register} errors={errors} size={CardSize.cart} />
        </Grid>
      </Grid>
    </CreateCartCardWrapper>
  );
};
